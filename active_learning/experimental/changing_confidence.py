...
Includes:
- DeclingConfidence from
	"A stopping criterion for active learning"
	by Andreas Vlachos
	https://dl.acm.org/doi/10.1016/j.csl.2007.12.001
- StaticConfidence from
    "Active learning stopping strategies for technology-assisted sensitivity review"
    by McDonald, Graham and Macdonald, Craig and Ounis, Iadh
    https://dl.acm.org/doi/abs/10.1145/3397271.3401267
"""
